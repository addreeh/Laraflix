<div>
    <button wire:click="openModal" type="button"
        class="bg-[#DD0E1F] text-xs text-white font-bold py-1 px-1.5 rounded-tl-sm transition hover:scale-110">More
        Info
    </button>
    @if ($isOpen)
...
<div class="p-5 flex flex-row gap-5">
    <div class="flex flex-col w-[40rem]">
        <div class="flex flex-row gap-5 text-sm mb-4">
            ...
            <p class="text-gray-300 pt-[0.1rem]">{{ $this->formatYear($data->Year) }}</p>
            <span
...
<div class="p-5 flex items-center gap-3 text-white">
    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-library" width="24" height="24"

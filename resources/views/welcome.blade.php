    ...
    <div>
        ...
        @auth
            @if (!empty($ratingFilms))
                <div class="h-auto banner2 absolute top-[38rem] w-full flex flex-col gap-2 justify-center py-5 px-14">
            ...
            <div
                ...
                <div class="flex flex-col text-white">
                    ...
                    <div class="flex flex-row mt-3 text-[#448ef4] text-lg items-center">
                        <a href="{{ route('login') }}">
                            <button type="button"
                                class="inline-flex items-center me-2 mb-2 transition hover:scale-110">Log
                                In

...
<div style="background-color: #222222; width: 100%; height: 100%;">
    ...
    ---------------------------*/
        ...
        <rect id="c-2" class="changeColor cls-7" x="74.82" y="26.48" width="19.14" height="2.45"
            transform="translate(1.29 -3.65) rotate(2.49)" style="fill: rgb(237, 16, 0);"></rect>
        ...
        <a href="{{ route('welcome') }}">
            ...
            <!-- Este rectángulo invisible actúa como área de clic -->
            <text id="title" transform="matrix(1 0 0 1 44.7249 78)" fill="#ffffff">404 😔 ERROR FOUND</text>
        </a>
    </svg>
</div>
